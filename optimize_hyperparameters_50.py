...
def logging_process_target(logging_queue, shutdown_event):
    ...
    file_handler = logging.FileHandler(f"optimize_hyperparameters_50.log", mode="w")
...
if __name__ == '__main__':
    ...
    output_file = open("r0486848_hyperparameter_optimization_results_50.txt", "w")
    ...
    try:
        ...
        logger.info(f'Starting hyperparameter optimization for instance size 50. PID = {os.getpid()}')
        np.random.seed(0)
