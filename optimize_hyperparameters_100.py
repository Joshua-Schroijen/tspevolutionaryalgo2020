...
if __name__ == '__main__':
    ...
    output_file = open("r0486848_hyperparameter_optimization_results_100.txt", "w")
    ...
    try:
        ...
        logger.info(f'Starting hyperparameter optimization for instance size 100. PID = {os.getpid()}')
        np.random.seed(0)
